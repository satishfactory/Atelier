...
-- Replace YOUR_USER_ID with your actual auth UUID from:
--   Supabase → Authentication → Users → copy your UUID
-- ============================================================

-- Set your user ID here once and it applies everywhere
DO $$
DECLARE
  uid UUID := 'YOUR_USER_ID';  -- ← REPLACE THIS
  base_url TEXT := 'https://atelier.satishfactory.com/hero';
BEGIN
...
('satish_room_ii', 'The Room at Villefranche', 'Satish Prabhu', '2024', 'artist_work', 'finished',
  base_url || '/at5.jpeg', uid,
...
('satish_memory_lane_ii', 'Memory Lane — Return', 'Satish Prabhu', '2025', 'artist_work', 'finished',
  base_url || '/at6.jpeg', uid,
  ...
  'Five sessions over three months. Most discussed painting — companion and artist disagreed on whether the figure is arriving or leaving. Artist finally accepted both. Score 74 → 87 across sessions.'),

('satish_after_loss_ii', 'After the Loss', 'Satish Prabhu', '2024', 'artist_work', 'finished',
  base_url || '/at8.jpeg', uid,
...
('satish_dance_of_life',  1, 'Started as a movement study. The figures feel disconnected still.', '2024-03-15', 71, 74, 67, 70, 78, 66, 72, 75, 68, 'text', uid),
('satish_dance_of_life',  2, 'The grief is coming through now. I stopped trying to make it joyful.', '2024-07-03', 79, 82, 74, 77, 86, 71, 80, 83, 75, 'text', uid),
('satish_dance_of_life',  3, 'Both things are true. Joy and mourning. I am done.', '2024-11-20', 84, 88, 79, 82, 91, 76, 85, 89, 80, 'text', uid),

('satish_absent_chair_ii', 1, 'The chair is too literal. Working on removing the obvious.', '2024-02-10', 68, 70, 63, 66, 79, 62, 70, 66, 72, 'text', uid),
('satish_absent_chair_ii', 2, 'Better. The companion asked about the political dimension. I disagree but it is interesting.', '2024-06-18', 79, 82, 74, 77, 88, 71, 80, 75, 83, 'text', uid),

('satish_memory_lane_ii',  1, 'Figure is too defined. Need to let the road take over.', '2025-01-08', 74, 72, 69, 72, 80, 70, 75, 74, 75, 'text', uid),
('satish_memory_lane_ii',  2, 'Three sessions this week. Something shifted.', '2025-02-14', 81, 79, 76, 79, 86, 76, 82, 80, 82, 'text', uid),
('satish_memory_lane_ii',  3, 'The question of arriving or leaving is now answered by refusing to answer.', '2025-03-22', 87, 85, 81, 83, 90, 80, 88, 84, 86, 'text', uid),

('satish_figures_coast',   1, 'Horizon line is fighting the figures. Needs to come down.', '2025-04-01', 64, 66, 60, 62, 68, 58, 64, 70, 62, 'text', uid),
('satish_figures_coast',   2, 'Better. The right figure is still not resolved.', '2025-04-20', 71, 74, 68, 70, 76, 65, 72, 78, 69, 'text', uid);

-- ── 4. Companion conversations ─────────────────────────────
INSERT INTO companion_conversations (painting_slug, role, message, session_date, user_id)
VALUES

('satish_dance_of_life', 'user', 'The figures feel too separate. How do I connect them without making it obvious?', '2024-07-03', uid),
('satish_dance_of_life', 'companion', 'The separation may be the subject. Grief and joy rarely hold hands — they orbit each other. What if the space between the figures is not a problem to solve but a tension to preserve? The eye moving between them enacts the dance itself.', '2024-07-03', uid),

('satish_absent_chair_ii', 'user', 'You mentioned the political reading. I don''t want that. It is personal.', '2024-06-18', uid),
('satish_absent_chair_ii', 'companion', 'I hear that — and you are right to hold the personal reading. But notice: the political and the personal are not competing interpretations. An empty chair in a domestic space carries both without confusion. Your resistance to the political reading may be exactly what gives the personal reading its integrity.', '2024-06-18', uid),

('satish_memory_lane_ii', 'user', 'Is the figure arriving or leaving? I can''t decide and it is stopping me.', '2025-02-14', uid),
('satish_memory_lane_ii', 'companion', 'The indecision is the painting''s intelligence, not your uncertainty. The figure carries both directions simultaneously — which is what memory does. You are not failing to decide; you are succeeding at the harder thing: holding the ambiguity. Do not resolve it.', '2025-02-14', uid),

('satish_after_loss_ii', 'user', 'I don''t know if I should say what this is about.', '2024-09-10', uid),
('satish_after_loss_ii', 'companion', 'You don''t have to. The painting already says it. What I can tell you is that the blue against that warm ground is not decorative — it is doing grief''s actual work. The tension between those temperatures is the loss, structurally present. You don''t need to name it in words for it to be fully there.', '2024-09-10', uid);
...
('satish_memory_lane_ii',
  'On Arriving and Leaving at the Same Time',
  E'# On Arriving and Leaving at the Same Time\n\nThere is a figure in this painting who has been walking away from me for three months.\n\nI cannot tell you which direction they are moving. I have tried to decide — committed to leaving in one session, committed to arriving in the next — and each time the painting refused the certainty. My companion said: *do not resolve it.* I fought that instruction. The painting won.\n\nWhat I discovered, slowly, is that the ambiguity is not a weakness in the work. It is the work. Memory does not travel in one direction. You can be returning to something and losing it simultaneously. The road in this painting is Mediterranean — a specific white, a specific heat — but it is also every road I have stood on and not known which way to move.\n\nThe figure''s back is deliberate. I spent a week on that back. Not the posture of departure, not the posture of arrival — the posture of someone in the middle of a decision that has already been made without their knowledge.\n\nBy the fifth session, I understood that the painting was not about a journey. It was about the moment before you know which journey you are on.\n\nI called it finished when I stopped trying to tell it what it meant.',
  198, 'published', uid),

('satish_dance_of_life',
  'The Space Between the Figures',
  E'# The Space Between the Figures\n\nI began this painting in joy. A study of movement, of bodies that know each other''s weight. I was in Lisbon. The light in March has a quality I have not found anywhere else — warm but not yet hot, the city still waking up.\n\nSix months later it became something else.\n\nI did not change the figures. I changed what I believed they were doing. In March they were dancing. By September, after a summer I would rather not describe in detail, I saw them differently. The same postures, the same hands — but now the dance was not celebration. It was what people do when they do not know what else to do with grief.\n\nMy companion asked me in session two whether I was going to repaint it. I said no. The figures were already right — I had just finally seen what they were.\n\nWhat painting teaches you, eventually, is that the subject arrives in its own time. You can be working on joy and find yourself, months later, holding a painting about loss. The paint does not lie. It just waits for you to catch up.\n\nBoth readings are correct. That is what I came to accept. Joy and mourning occupy the same bodies, the same afternoon light, the same space between two figures who are dancing because there is nothing else to do.',
  226, 'published', uid),

('satish_after_loss_ii',
  'The Colour of After',
  E'# The Colour of After\n\nThis painting was made in the weeks after my father died.\n\nI am not sure I would have begun it if I had known that was what I was doing. Grief has a way of disguising itself as a colour problem, a composition question, an afternoon in the studio. You think you are solving something technical. You find out later what you were actually doing.\n\nThe blue-green against the warm ochre ground: I mixed that combination on instinct. Did not think about it. Came back the next day and understood why I had chosen it — those temperatures are at war in a way that does not resolve. The cool does not win. The warm does not win. They sit in tension. That is the accurate colour of after.\n\nMy companion said the painting does not collapse into sentiment. That was the best thing anyone said to me that month. Grief without sentimentality is the hardest thing — the temptation is to let the paint cry, to let the composition weep, to make the mourning legible and comfortable for the viewer. This painting refuses that comfort.\n\nI do not know if it is the best painting I have made. But it is the most honest.\n\nThat distinction — between best and honest — is something Atelier has helped me understand. The scores gave me language for what the painting was doing structurally. The conversations gave me permission to say what it was doing personally. Both were necessary.',
  249, 'published', uid);

-- ── 6. Inspirations ───────────────────────────────────────
INSERT INTO inspirations (user_id, title, creator, type, intensity, influence_note, active)
VALUES
  (uid, 'The Dance', 'Henri Matisse', 'painter', 9, 'The relationship between figures that do not touch but are in complete conversation. I return to this constantly when working on multi-figure compositions.', true),
  (uid, 'Dance of Life', 'Edvard Munch', 'painter', 8, 'Joy and grief in the same image without irony. The figures in white, red, and black contain an entire life. This is the work I measure my Dance of Life against.', true),
  (uid, 'Card Players', 'Paul Cézanne', 'painter', 9, 'The dignity of ordinary presence. How Cézanne makes a man at a table into a monument without heroism. I want that stillness.', true),
  (uid, 'Ways of Seeing', 'John Berger', 'book', 7, 'Berger''s writing on the nude and on landscape changed how I think about what the viewer brings to the work. Every time I doubt a painting I reread the oil painting chapter.', true),
  (uid, 'The Ongoing Moment', 'Geoff Dyer', 'book', 6, 'A book about photography that taught me more about painting than most painting books. The chapter on roads and horizons is in my head every time I set a figure against a landscape.', true);
